...
return (
    ...
    <h1 className="text-5xl font-bold mt-12 text-center">About</h1>

    <div className="flex-1 flex items-center justify-center w-full">
        <div className="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 p-8 rounded-xl shadow-lg max-w-2xl text-center">
